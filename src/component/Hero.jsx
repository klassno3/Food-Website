    ...
    <div className=' w-11/12 mx-auto mt-10'>
      <div className="flex w-full sm:w-10/12 mx-auto lg:w-full lg:flex-row flex-col justify-center ">
        <div className="w-full  lg:w-3/5 ">
          <img className="lg:rounded-l-md rounded-t-md w-full h-full"src={HeroPic} alt="" />
        </div>
        <div className="w-full lg:rounded-r-md rounded-b-md bg-Secondary-Blue-100 lg:w-2/5 ">
